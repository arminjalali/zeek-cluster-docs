...
- Apply performance and AF_PACKET tuning: [`docs/03-optimization.md`](docs/03-optimization.md)
- Set up monitoring scripts: [`docs/04-monitoring.md`](docs/04-monitoring.md)
